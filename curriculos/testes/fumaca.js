...
const rotas=['/','/medicina','/medicina/inst/ufam','/medicina/inst/uea','/medicina/importar','/medicina/comparar','/medicina/especialidades','/medicina/esp/cardiologia',
 ...
 '/questoes','/erros','/flashcards','/flashcards/estudar','/revisoes','/revisoes/erros','/casos','/casos/caso-malaria-vivax','/jogos','/jornada','/jogos/caso','/jogos/termo','/jogos/pares','/jogos/anatomia','/jogos/relogio','/simulados','/plano','/desempenho',
