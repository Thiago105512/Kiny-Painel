...
ARMAS = [
    ...
    ("vancomicina", "Vancomicina IV", "Glicopeptídeo", "#AD1457"),
    ("vancomicina-oral", "Vancomicina oral", "Glicopeptídeo (ação intraluminal)", "#F06292"),
...
INVASORES = [
    ...
    (1, "bacteria", "Hanseníase multibacilar",
     "Mais de 5 placas hipoestésicas e espessamento do nervo ulnar",
     "pqt-u", [],
     "Mais de 5 lesões (ou baciloscopia positiva) = multibacilar: PQT-U (rifampicina, dapsona, clofazimina) por 12 doses mensais supervisionadas.",
    ...
    (1, "bacteria", "Otite média aguda",
     "Criança de 18 meses, febre 39 °C, otalgia, tímpanos abaulados bilaterais; sem ATB recente",
     "amoxicilina", [],
     "< 2 anos com OMA bilateral: tratar (sem observação). Amoxicilina (dose alta, 80-90 mg/kg/dia) é 1ª escolha: cobre o pneumococo.",
    ...
    (1, "bacteria", "Meningite bacteriana",
     ...
     "Vancomicina IV: sozinha não cobre meningococo nem hemófilo; se usada (pneumococo resistente), vai junto da ceftriaxona."),
    ...
    (1, "fungo", "Candidíase vulvovaginal",
     ...
     "PCDT IST: 1ª opção creme vaginal (miconazol 7 dias ou nistatina 14 dias); fluconazol 150 mg VO dose única é a alternativa oral.",
    ...
    (2, "protozoario", "Leishmaniose cutânea braziliensis",
     ...
     "L. braziliensis: antimoniato de meglumina 15 mg Sb/kg/dia (10-20) por 20 dias segue 1ª escolha do MS; miltefosina VO é a opção oral no SUS.",
    ...
    (3, "bacteria", "Descalonar: MSSA na hemocultura",
     ...
     "Vancomicina IV: manter é pior para MSSA (mais falha e mortalidade)."),
...
def validar(armas, invasores):
    ...
    if not 26 <= len(armas) <= 33:
        erros.append(f"{len(armas)} armas (esperado 26-33)")
    for a in armas:
