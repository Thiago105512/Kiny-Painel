...
GRUPOS = [
    {
        ...
        "perguntas": [
            ...
            ("Febre prolongada com roséolas no tronco?", ["Febre tifoide"]),
    ...
    },
    {
        ...
        "perguntas": [
            ("Origem no coração ou no pericárdio?",
    ...
    },
    {
        ...
        "notas": {
            ...
            "Anemia de doença crônica": "Em geral normocítica; ferro baixo com ferritina normal ou alta (hepcidina elevada).",
            "Talassemia beta menor": "Microcitose acentuada com Hb pouco baixa e HbA2 aumentada; ferritina normal.",
            "Anemia falciforme": "HbS: crises vaso-oclusivas, hemólise e asplenia funcional. Rastreada no teste do pezinho.",
        ...
        "perguntas": [
            ...
            ("É megaloblástica (macrocítica)?", ["Deficiência de B12", "Deficiência de folato"]),
            ("Ferritina baixa?", ["Ferropriva"]),
            ("Ferro baixo com ferritina normal ou alta?", ["Anemia de doença crônica"]),
            ("Causa neuropatia e degeneração medular?", ["Deficiência de B12"]),
            ("É hereditária?",
    ...
    },
    {
        ...
        "perguntas": [
            ...
            ("Transmissão sobretudo parenteral ou sexual?", ["Hepatite B", "Hepatite C", "Hepatite D"]),
            ...
            ("AST/ALT > 2 em etilista pesado?", ["Hepatite alcoólica"]),
    ...
    },
    {
        ...
        "perguntas": [
            ...
            ("Produz pigmento verde (piocianina)?", ["Pseudomonas"]),
    ...
    },
    {
        ...
        "perguntas": [
            ("Tireotoxicose faz parte do quadro típico?",
    ...
    },
    {
        ...
        "perguntas": [
            ("Hemólise por anticorpo materno (aloimune)?", ["Isoimunização Rh", "Incompatibilidade ABO"]),
            ("É causa hemolítica?",
