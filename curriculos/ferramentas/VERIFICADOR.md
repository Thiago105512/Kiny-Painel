...
Saída: <LOTE>.respostas.json — array JSON com um objeto por questão:
  {"id": "...", "resposta": <0-4>, "confianca": "alta"|"media"|"baixa", "ambigua": true|false, "nivel": 1|2|3, "justificativa": "1–3 frases"}
  "nivel" = sua estimativa da dificuldade real (1 reconhecer; 2 aplicar/distinguir; 3 várias etapas/cálculo/exceção).
