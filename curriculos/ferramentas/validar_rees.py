...
for q in novo:
    ...
    for k in q:
        if k not in ("id","area","enunciado","alternativas","correta","explicacao","tema","subtema","especialidade","disciplina","areaEnem","dificuldade","fonte","ano","prova","revisado","serie","parte","partes","imagem"): E.append(f"{onde}: campo desconhecido {k}")
