...
| 31 | `#/config` | Dados | Profissional responsável (nome, especialidade, CRM, RQE – padrão: Dra. Catarina Ribeiro de Queiroz, Pediatra, CRM/AM 10.677, RQE 6.706), exportar/importar JSON, apagar, contagem das bases carregadas a sincronização opcional pelo Firebase, o espaço compartilhado entre duas pessoas (criar, convidar por e-mail, entrar por código) e a ligação com a agenda do Google. |
