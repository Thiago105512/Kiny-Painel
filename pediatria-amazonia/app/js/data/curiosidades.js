...
PED.data.curiosidades = {
  ...
  porDoenca: {
    ...
    hiv_pediatrico: [
      { tipo: 'historia', texto: 'Em 1994 o estudo ACTG 076 mostrou que a zidovudina dada à gestante, no parto e ao recém-nascido reduzia a transmissão vertical em cerca de dois terços. Foi o resultado que transformou o HIV pediátrico de destino em evento evitável, e hoje, com pré-natal completo, a transmissão pode ficar abaixo de 1%.' },
      { tipo: 'regional', texto: 'No Amazonas, a distância até o pré-natal, a testagem tardia na gestação e a dificuldade de acesso à fórmula infantil em comunidade ribeirinha e indígena ainda produzem casos de transmissão vertical que seriam evitáveis. Cada caso encontrado é também uma pergunta sobre o que faltou no caminho até o parto.' },
      { tipo: 'pratica', texto: 'Criança vivendo com HIV em tratamento adequado cresce, vacina-se e frequenta escola como qualquer outra. O maior desafio clínico da adolescência não é o vírus: é a adesão, e ela depende de a criança saber do próprio diagnóstico, revelação que se faz de forma gradual e planejada com a equipe e a família.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: com o remédio tomado todo dia, no mesmo horário, o vírus fica tão baixinho que não faz mal e não passa para outras pessoas. Ela vai crescer, estudar e brincar como as outras crianças. Não precisa separar prato, copo, roupa nem banheiro, e abraço e beijo não passam nada. Quem decide quando e para quem contar é a família, junto comigo.' }
    ],

    glomerulonefrite_pos_estreptococica: [
      { tipo: 'pratica', texto: 'O intervalo entre a infecção e a nefrite depende de onde a bactéria estava: cerca de uma a duas semanas depois de uma faringite, mas três a seis semanas depois de uma infecção de pele. Em região de clima quente, a piodermite é o antecedente mais frequente, e a família já esqueceu a ferida quando a urina escurece.' },
      { tipo: 'sabia', texto: 'O complemento C3 cai na fase aguda e volta ao normal em até oito semanas. C3 que permanece baixo depois desse prazo deixa de apoiar o diagnóstico e obriga a pensar em outra glomerulopatia: é um dos exames mais úteis e mais esquecidos do seguimento.' },
      { tipo: 'regional', texto: 'Onde escabiose e impetigo são frequentes, a nefrite pós-estreptocócica aparece em blocos, com vários casos na mesma comunidade em poucas semanas. Um caso deve levantar a pergunta sobre outras crianças da mesma casa e da mesma escola.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: o rim ficou inflamado por causa daquela ferida ou daquela dor de garganta que ele teve semanas atrás. Na maior parte das vezes o rim se recupera sozinho e volta ao normal. O que a gente precisa agora é tirar o sal da comida, medir o peso e a pressão todo dia e controlar o quanto ele bebe. A urina cor de coca-cola vai clareando aos poucos.' }
    ],

    otite_media_aguda: [
      { tipo: 'sabia', texto: 'A tuba auditiva do lactente é mais curta, mais larga e quase horizontal, o que facilita a subida de secreção da rinofaringe para a orelha média. Ela só vai se inclinando ao longo dos primeiros anos, e é por isso que a otite tem pico entre seis e vinte e quatro meses e vai ficando rara depois.' },
      { tipo: 'pratica', texto: 'Timpânico vermelho sozinho não fecha diagnóstico: criança que chora fica com a membrana hiperemiada. O que sustenta a otite média aguda é o abaulamento da membrana, com perda dos pontos de referência, ou a otorreia de início recente.' },
      { tipo: 'regional', texto: 'A fumaça de fogão a lenha dentro de casa, a alta frequência de viroses respiratórias e a dificuldade de acesso a otoscópio e a especialista favorecem, no interior, tanto o subdiagnóstico quanto o excesso de antibiótico. Perguntar sobre fumaça em casa é parte da consulta de otite.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: nas primeiras horas o que mais importa é tirar a dor, porque a dor de ouvido é das piores que existem. Se sair secreção pelo ouvido, quer dizer que o tímpano furou: costuma doer menos na hora, e ele se fecha sozinho depois. Não pingue nada no ouvido por conta própria, nem óleo, nem folha, nem remédio de outra vez. E dar mamadeira com a criança deitada faz o líquido subir para o ouvido.' }
    ],

    faringoamigdalite_estreptococica: [
      { tipo: 'pratica', texto: 'Tosse, coriza, rouquidão, conjuntivite e afta apontam para vírus, não para estreptococo. Abaixo de três anos a faringite estreptocócica é incomum e a febre reumática é rara, o que muda bastante o limiar para tratar nessa faixa.' },
      { tipo: 'sabia', texto: 'O tratamento pode começar até o nono dia do início dos sintomas e ainda assim prevenir a febre reumática. Isso dá margem para esperar um exame ou reavaliar a criança, algo que se perde quando se prescreve antibiótico na primeira consulta por precaução.' },
      { tipo: 'regional', texto: 'Quando o retorno é incerto, como para famílias que vêm de comunidade distante e voltam de barco no mesmo dia, a penicilina benzatina em dose única resolve o tratamento inteiro ali. É um raciocínio geográfico, não uma preferência farmacológica.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: a maior parte das dores de garganta de criança é virose e não melhora com antibiótico. Quando eu receito é porque vi sinal dessa bactéria, e aí o objetivo é proteger o coração dela lá na frente. Se for comprimido ou xarope, vai até o décimo dia mesmo com a garganta boa no terceiro.' }
    ],

    laringite_viral: [
      { tipo: 'sabia', texto: 'Crupe vem de uma palavra escocesa antiga que descrevia gritar rouco. A tosse de cachorro, a rouquidão e o estridor vêm do estreitamento logo abaixo das cordas vocais, a região mais estreita da via aérea da criança pequena, onde poucos milímetros de edema fecham muito da luz.' },
      { tipo: 'pratica', texto: 'Manter a criança calma e no colo do acompanhante é intervenção terapêutica, não gentileza: choro e agitação aumentam a turbulência do fluxo e pioram a obstrução. Adiar procedimento não essencial faz parte do tratamento. Estridor só ao chorar é diferente de estridor em repouso, e essa distinção é a que orienta a gravidade.' },
      { tipo: 'regional', texto: 'A cena é conhecida: a criança piora de madrugada, a família sai de casa apavorada e ela chega ao serviço visivelmente melhor. O ar frio e úmido da noite e o fato de ela se acalmar no colo durante o trajeto explicam boa parte disso, e a melhora no caminho não significa que a avaliação deixou de ser necessária.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: essa tosse rouca, de latido de cachorro, costuma piorar de madrugada e assustar, e nas próximas noites pode voltar mais fraca. Fique calma perto dele, porque criança que chora respira pior. O que eu preciso que a senhora observe é se ele faz um barulho na inspiração mesmo paradinho e quieto, se afunda o peito ou fica roxo em volta da boca: aí volta na hora.' }
    ],

    hantavirose: [
      { tipo: 'historia', texto: 'O nome vem do rio Hantan, na Coreia, onde o primeiro hantavírus foi isolado depois da epidemia de febre hemorrágica que atingiu tropas durante a Guerra da Coreia. A forma pulmonar americana, muito mais letal, só foi reconhecida em 1993, num surto no sudoeste dos Estados Unidos.' },
      { tipo: 'regional', texto: 'Na Amazônia os casos se concentram em fronteira agrícola, assentamento, ramal, garimpo, acampamento e sítio, ligados à limpeza de paiol, tulha, galpão e casa fechada há muito tempo, e ao manuseio de grão armazenado como milho, arroz e castanha. O risco cresce na época da colheita e do armazenamento, quando a população de roedores aumenta.' },
      { tipo: 'pratica', texto: 'A fase prodrômica é indistinguível de dengue ou de uma síndrome gripal, e é justamente nela que a suspeita salva: a passagem para a fase cardiopulmonar é abrupta. Hematócrito subindo com plaquetas caindo antecede essa virada, e a letalidade da forma cardiopulmonar no Brasil é elevada, em torno de 40%.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: essa doença vem do xixi e do cocô secos de rato do mato, que viram poeira quando a gente varre. Antes de entrar em paiol, tulha ou casa fechada há muito tempo, abra tudo e deixe arejar por pelo menos meia hora, de longe. Molhe o chão antes de varrer, nunca varra a seco, e proteja o nariz e a boca com pano. Guarde grão e castanha em vasilha fechada e longe de onde as crianças dormem.' }
    ],

    acidente_arraia: [
      { tipo: 'regional', texto: 'As arraias de água doce do gênero Potamotrygon ficam semienterradas no fundo arenoso de rios, igarapés, lagos e praias. Os acidentes se concentram na vazante e na seca, quando a água baixa, as praias afloram e as arraias se concentram nas áreas rasas onde as crianças tomam banho e ajudam na pesca: quase sempre em pé, tornozelo e perna.' },
      { tipo: 'sabia', texto: 'O ferrão fica na base da cauda e é retrosserrilhado, voltado para trás: ele entra com relativa facilidade e rasga o tecido ao ser retirado, podendo deixar fragmentos dentro da ferida. Por isso a lesão é desproporcionalmente feia e dolorosa para o tamanho do animal.' },
      { tipo: 'pratica', texto: 'A medida que mais alivia a dor é a imersão em água morna, na maior temperatura que a pele tolera sem queimar, porque o veneno tem componentes termolábeis. A temperatura tem que ser testada por um adulto na própria mão antes de colocar a criança, e a supervisão precisa ser contínua: queimadura por água quente nesse contexto é um risco real.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: quando entrar na água, ensine a criança a ir arrastando os pés na areia, sem levantar o pé para pisar. A arraia sente a vibração e sai de baixo; quem pisa em cima é que leva a ferroada. Se acontecer, água morna para a dor, nunca gelo, nunca amarrar, nunca cortar e nunca passar folha ou pó na ferida. E venha, porque a ferida costuma infectar depois.' }
    ],

    ferimento_peixe: [
      { tipo: 'regional', texto: 'É um agravo cotidiano em comunidade ribeirinha, indígena e de pescadores, onde crianças participam da pesca e da limpeza do pescado desde cedo: espinho de bagre e de mandi, dente de piranha, nadadeira, anzol e faca de limpeza, nas mãos, e corte na sola do pé na beira. A água de rio e igarapé é rica em Aeromonas hydrophila, que causa infecção de partes moles de evolução rápida.' },
      { tipo: 'sabia', texto: 'Mycobacterium marinum cresce melhor em torno de 30 a 33 graus, abaixo da temperatura central do corpo. É por isso que ele produz nódulos arrastados justamente na mão e no antebraço, as partes mais frias, e quase nunca infecção profunda, e por isso a lesão evolui em semanas, não em horas, sendo confundida com outras dermatoses.' },
      { tipo: 'pratica', texto: 'O espinho de bagre e de mandi tem glândula de veneno na base, e a dor responde à imersão em água morna como no acidente por arraia, pela mesma razão: o veneno é termolábil. Ferimento contaminado, profundo ou de atendimento tardio não se fecha de forma hermética, e a situação vacinal antitetânica precisa ser checada sempre.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: lave na hora com bastante água limpa e mantenha a ferida coberta e fora da água do rio até fechar, porque o que infecta é o rio entrando na ferida todo dia. Se em poucas horas a vermelhidão crescer, a dor aumentar muito ou aparecer febre, volte correndo: aqui as infecções de ferida de peixe correm rápido.' }
    ],

    miiase: [
      { tipo: 'sabia', texto: 'A mosca do berne, Dermatobia hominis, não pousa na pessoa para botar ovo: ela captura outro inseto em voo, geralmente um mosquito, cola os ovos no corpo dele e o solta. Quando esse carregador pousa para picar, o calor do corpo faz os ovos eclodirem na hora e a larva entra pela pele. É um dos casos mais engenhosos de transporte de parasita que se conhece.' },
      { tipo: 'regional', texto: 'A forma furunculoide pelo berne é a mais comum, em área de mata e de criação de gado. Já a bicheira, por Cochliomyia hominivorax, ataca ferida aberta, coto umbilical de recém-nascido, couro cabeludo com piolho, lesão de sarna infectada e ouvido com secreção: onde há ferida descoberta e mosca, há risco.' },
      { tipo: 'pratica', texto: 'Romper ou fragmentar a larva durante a retirada provoca reação inflamatória intensa, granuloma e infecção secundária. Daí a manobra de ocluir o orifício e esperar a larva emergir, em vez de espremer.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: não espreme e não fura em casa, porque se a larva arrebentar por dentro inflama muito e infecta. Ferida de criança tem que ficar sempre limpa e coberta, principalmente o umbigo do recém-nascido, a cabeça de quem tem piolho e a ferida de quem está com sarna: é aí que a mosca bota. Se aparecer um caroço que dói, mexe e tem um furinho no meio, traga para tirar aqui.' }
    ],

    tungiase: [
      { tipo: 'sabia', texto: 'A fêmea da Tunga penetrans se enterra na pele e aumenta cerca de duas mil vezes de tamanho enquanto desenvolve os ovos: o caroço branco com ponto escuro no meio é o corpo dela cheio. É a menor pulga conhecida e, segundo o relato clássico, foi levada da América do Sul para a África no século XIX na areia de lastro de um navio, espalhando-se pelo continente em poucas décadas.' },
      { tipo: 'regional', texto: 'É doença de solo arenoso, seco e sombreado, de terreiro, chiqueiro, galinheiro e casa de chão batido, com cão, porco e galinha mantendo o ciclo no peridomicílio. Aumenta no período seco e recai desproporcionalmente sobre crianças em idade escolar que brincam descalças.' },
      { tipo: 'pratica', texto: 'O peso da tungíase não está na lesão isolada e sim na carga: dor ao caminhar, falta à escola, deformidade de unha, infecção secundária e risco de tétano. Agulha, alfinete ou espinho compartilhados, prática comum na comunidade, somam infecção e risco de transmissão de patógeno pelo sangue.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: não tire com agulha ou alfinete em casa, e principalmente não use a mesma agulha em mais de uma pessoa, porque é assim que infecciona e que se passa doença de sangue. Traga aqui para tirar com material limpo. Depois, o que evita voltar é sandália no pé, varrer e molhar o terreiro, e afastar porco, galinha e cachorro de onde as crianças brincam.' }
    ],

    larva_migrans_cutanea: [
      { tipo: 'sabia', texto: 'A larva é de ancilostomídeo de cão e gato, e o ser humano é hospedeiro errado: ela não consegue atravessar a membrana basal e fica presa na epiderme, andando em círculos até morrer. É exatamente esse beco sem saída que torna a doença autolimitada e impede que ela se torne sistêmica.' },
      { tipo: 'regional', texto: 'O cenário clássico no Amazonas é a praia de rio que aflora na vazante e na seca, muito frequentada por crianças e também por cães, além de terreiro sombreado, barranco e o chão embaixo de casa suspensa. Areia úmida e sombreada com fezes de cão e gato é tudo de que a larva precisa.' },
      { tipo: 'pratica', texto: 'O trajeto serpiginoso avança alguns milímetros a poucos centímetros por dia, e marcar a ponta da lesão com caneta ajuda a confirmar o diagnóstico e a mostrar resposta ao tratamento. O que leva à complicação não é a larva, é a escoriação de tanto coçar e a infecção bacteriana que vem depois.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: o bicho geográfico pega de sentar ou andar descalço na areia da praia e no chão de terra onde cachorro e gato fazem cocô. Leve uma esteira ou um pano para a criança sentar, sandália no pé e, quando der, vermifugue os cães de casa. Ela não passa de criança para criança, então não precisa faltar à escola.' }
    ],

    ictericia_neonatal: [
      { tipo: 'historia', texto: 'A fototerapia nasceu de uma observação de enfermagem: no fim dos anos 1950, num hospital em Essex, na Inglaterra, a irmã Jean Ward reparou que os bebês que ela levava para tomar sol no pátio ficavam menos amarelos, e no laboratório uma amostra de sangue esquecida perto da janela perdeu a cor. Cremer publicou o achado em 1958 e mudou o tratamento da icterícia no mundo inteiro.' },
      { tipo: 'pratica', texto: 'A avaliação visual engana, tanto em pele clara quanto em pele escura, e a decisão se toma comparando a bilirrubina com o limiar correspondente à hora de vida e ao grupo de risco. Icterícia que aparece antes de 24 horas de vida nunca é fisiológica.' },
      { tipo: 'sabia', texto: 'A bilirrubina, em concentração baixa, tem ação antioxidante, e há quem veja aí uma explicação evolutiva para a icterícia leve ser quase universal no recém-nascido. O problema não é ela existir, e sim ultrapassar o limiar que permite atravessar para o cérebro.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: essa luz azul não é raio X e não esquenta como fogo, ela só desmancha o amarelo do sangue pela pele. Por isso ele fica de fralda, com a venda protegendo os olhos, e a gente tira só para mamar. Quanto mais ele mamar, mais rápido elimina. E não adianta colocar no sol da janela ou do quintal: sol não substitui essa luz e ainda queima a pele dele.' }
    ],

    sepse_neonatal: [
      { tipo: 'pratica', texto: 'No recém-nascido a hipotermia é tão ou mais preocupante que a febre, e os sinais são inespecíficos: recusa alimentar, gemência, hipoatividade, distermia, apneia. O antibiótico empírico entra na primeira hora, depois das culturas, sem esperar resultado nem transferência.' },
      { tipo: 'sabia', texto: 'A divisão entre sepse precoce, antes de 72 horas, e tardia não é burocrática: a precoce reflete o que veio da mãe e do canal de parto, e a tardia o que foi adquirido depois, na comunidade ou no cuidado de saúde. Os agentes prováveis são diferentes, e é isso que orienta o esquema empírico.' },
      { tipo: 'regional', texto: 'Quando a criança nasce em casa, na comunidade, ou chega depois de horas de viagem de rio, a história do pré-natal e do parto muitas vezes não vem escrita. Perguntar sobre bolsa rota, febre materna, tempo de trabalho de parto e quem fez o parto substitui o cartão que não chegou.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: bebê recém-nascido não tem como mostrar que está infectado do jeito que uma criança maior mostra. Ele não faz febre alta, ele fica largado, para de mamar, fica gemendo ou fica frio demais. Por isso a gente age rápido e começa o antibiótico antes mesmo de ter o resultado do exame. Se algum desses sinais aparecer em casa depois da alta, volte na hora, não espere amanhecer.' }
    ],

    desconforto_respiratorio_rn: [
      { tipo: 'historia', texto: 'Em 1959, Mary Ellen Avery e Jere Mead mostraram que faltava surfactante nos pulmões dos bebês que morriam de doença da membrana hialina. A pista é que o pulmão desses recém-nascidos não se comportava como os outros nos testes de tensão superficial. Décadas depois, o surfactante exógeno chegou à clínica e mudou a sobrevida do prematuro como poucas coisas na história da pediatria.' },
      { tipo: 'sabia', texto: 'A gemência não é apenas sinal de sofrimento: o bebê fecha parcialmente a glote na expiração para segurar pressão e manter os alvéolos abertos. Ele está fazendo o próprio CPAP. É por isso que a gemência desaparece rapidamente quando se instala o CPAP nasal.' },
      { tipo: 'pratica', texto: 'Manter o recém-nascido em ambiente térmico neutro faz parte do tratamento respiratório, não é conforto: frio aumenta o consumo de oxigênio e piora a acidose. E a meta de saturação evita tanto a hipoxemia quanto a hiperóxia, especialmente no prematuro.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: esse barulhinho que ele faz ao soltar o ar é o próprio corpo dele tentando manter o pulmão aberto. O aparelho que vamos colocar no nariz sopra um pouco de ar para ajudar nisso, e não é o mesmo que respirador. Ele vai continuar respirando sozinho, só com uma ajuda.' }
    ],

    hipoglicemia_neonatal: [
      { tipo: 'sabia', texto: 'O cérebro do recém-nascido consegue usar lactato e corpos cetônicos além da glicose, e é por isso que os limiares numéricos variam entre diretrizes e por hora de vida. O que não varia é a conduta diante do recém-nascido sintomático: ali não se discute número, se corrige.' },
      { tipo: 'pratica', texto: 'Os grupos de risco são conhecidos e previsíveis: prematuro, pequeno e grande para a idade gestacional, filho de mãe diabética, e todo recém-nascido com hipotermia, dificuldade de mamar ou apneia. Glicemia capilar em qualquer recém-nascido com tremor, hipotonia, sucção débil ou convulsão é regra.' },
      { tipo: 'regional', texto: 'Frio e jejum caminham juntos: recém-nascido que fez viagem longa de barco, molhado, sem contato pele a pele e sem mamar, chega hipotérmico e com risco de hipoglicemia por dois caminhos ao mesmo tempo. Aquecer e alimentar é a primeira parte do atendimento.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: bebê gasta açúcar muito rápido, e gasta ainda mais quando está com frio. Mantenha ele pele a pele com a senhora, bem coberto, e ofereça o peito sempre que ele acordar, sem esperar dar horário. Se ele ficar tremendo, molinho, muito frio ou difícil de acordar para mamar, procure a unidade.' }
    ],

    sifilis_congenita: [
      { tipo: 'sabia', texto: 'O Treponema pallidum nunca desenvolveu resistência à penicilina: mais de oitenta anos depois, ela continua sendo o único tratamento recomendado, e não há esquema alternativo com a mesma eficácia para curar o feto. É um caso raríssimo na história dos antibióticos.' },
      { tipo: 'pratica', texto: 'Mais da metade dos recém-nascidos com sífilis congênita é assintomática ao nascer, e é por isso que todo bebê de mãe com sífilis é investigado, e não apenas o que parece doente. Tratar a criança sem tratar a parceria da mãe é garantir a reinfecção e o próximo caso.' },
      { tipo: 'regional', texto: 'Sífilis congênita é evento sentinela da qualidade do pré-natal: cada caso aponta um teste que não foi feito, um resultado que não voltou, um tratamento que não foi completado ou um parceiro que não foi tratado. No interior, a distância até o pré-natal e o retorno para a segunda dose são os pontos onde a cadeia mais costuma quebrar.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: essa é uma doença que passa da mãe para o bebê na gravidez e tem tratamento e cura, e ninguém aqui está julgando a senhora. Vamos tratar o bebê com injeção e acompanhar com exames de sangue por alguns meses, e é importante que ele volte nas datas certas mesmo estando bem. O pai ou o companheiro também precisa se tratar, senão a doença volta.' }
    ],

    reanimacao_neonatal_dx: [
      { tipo: 'historia', texto: 'Virginia Apgar criou seu escore em 1952 quase como uma provocação: anestesista, incomodava-se com o fato de ninguém avaliar o bebê de forma padronizada logo após o nascimento. A regra mnemônica com as letras do sobrenome dela, Appearance, Pulse, Grimace, Activity e Respiration, veio só onze anos depois, criada por outro médico.' },
      { tipo: 'pratica', texto: 'O escore de Apgar não orienta a reanimação e não se espera o primeiro minuto para agir: a decisão se toma em segundos pela respiração, pelo tônus e pela frequência cardíaca. O Apgar serve para descrever e comparar, não para conduzir.' },
      { tipo: 'sabia', texto: 'A maioria esmagadora dos recém-nascidos que precisa de ajuda responde apenas à ventilação eficaz com máscara. Massagem cardíaca e medicação são necessárias numa minoria muito pequena, e é por isso que o treinamento insiste tanto em ventilação bem feita antes de qualquer outra coisa.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: ele demorou um pouco para começar a respirar sozinho e precisou da nossa ajuda com a máscara nos primeiros minutos. Isso é mais comum do que parece e a maioria dos bebês responde bem, como ele respondeu. Agora vamos acompanhar de perto nas próximas horas, e assim que estiver estável a senhora vai poder ficar com ele pele a pele.' }
    ]
...
,
  ...
  porMedicamento: {
    ...
    ciprofloxacino: [
      { tipo: 'sabia', texto: 'Toda a família das quinolonas começou num subproduto: em 1962, ao purificar cloroquina, George Lesher isolou uma impureza com atividade antibacteriana, o ácido nalidíxico. O ciprofloxacino é um descendente distante daquele acaso. A restrição histórica em pediatria veio de lesão de cartilagem observada em animais jovens, e os dados acumulados em crianças levaram as diretrizes a admiti-lo em situações definidas, quando é a melhor opção disponível.' },
      { tipo: 'explicarFamilia', texto: 'Para explicar em casa: dê com bastante água e não junto com leite, iogurte, antiácido ou o remédio de ferro, porque esses grudam no antibiótico e ele deixa de ser absorvido. Espere pelo menos duas horas entre um e outro. Durante o tratamento, evite sol forte e use camiseta e boné, porque a pele queima com mais facilidade. Se ela reclamar de dor em tendão ou articulação, me avise.' }
    ],
...
,
  ...
  quiz: [
    ...
    { pergunta: 'Qual a conduta com vitamina A em toda criança com sarampo?', resposta: 'Duas doses por via oral, no dia do diagnóstico e no dia seguinte, independentemente do estado nutricional: 50.000 UI por dose abaixo de 6 meses, 100.000 UI de 6 a 11 meses e 200.000 UI a partir de 12 meses.', tema: 'sarampo' },
    { pergunta: 'Como a coqueluche se apresenta no lactente pequeno?', resposta: 'Frequentemente sem guincho: apneia, cianose e engasgo. Leucocitose com linfocitose acentuada é achado clássico e se correlaciona com gravidade.', tema: 'coqueluche' },
    { pergunta: 'O exantema que surge após amoxicilina na mononucleose indica alergia à penicilina?', resposta: 'Não, e não contraindica o uso futuro de penicilina. Rotular a criança como alérgica por esse motivo é um erro com consequências duradouras.', tema: 'mononucleose' },
    { pergunta: 'Quanto tempo separa a infecção estreptocócica da glomerulonefrite, e o que muda conforme o sítio?', resposta: 'Cerca de 1 a 2 semanas após faringite e 3 a 6 semanas após piodermite. Em clima quente a pele é o antecedente mais comum, e a família já esqueceu a ferida.', tema: 'glomerulonefrite_pos_estreptococica' },
    { pergunta: 'Qual achado otoscópico sustenta o diagnóstico de otite média aguda?', resposta: 'Abaulamento da membrana timpânica com perda dos pontos de referência, ou otorreia de início recente. Hiperemia isolada não basta, porque o choro avermelha a membrana.', tema: 'otite_media_aguda' },
    { pergunta: 'Até quando o antibiótico ainda previne febre reumática na faringoamigdalite estreptocócica?', resposta: 'Até o nono dia do início dos sintomas, o que dá margem para aguardar teste ou reavaliar antes de prescrever.', tema: 'faringoamigdalite_estreptococica' },
    { pergunta: 'Que par de exames antecede a virada para a fase cardiopulmonar da hantavirose?', resposta: 'Hematócrito em elevação com plaquetas em queda. A fase prodrômica é indistinguível de síndrome gripal e a letalidade da forma cardiopulmonar no Brasil é elevada.', tema: 'hantavirose' },
    { pergunta: 'Qual a medida que mais alivia a dor no acidente por arraia, e qual o cuidado obrigatório?', resposta: 'Imersão em água morna, na maior temperatura tolerável sem queimar, por 30 a 90 minutos. A temperatura deve ser testada por um adulto antes e a supervisão ser contínua, pelo risco real de queimadura.', tema: 'acidente_arraia' },
    { pergunta: 'Quais agentes tornam o ferimento em ambiente aquático amazônico diferente de um corte comum?', resposta: 'Aeromonas hydrophila, de evolução rápida em partes moles, e Mycobacterium marinum, de curso arrastado em mão e antebraço. Avaliar sempre a situação vacinal antitetânica.', tema: 'ferimento_peixe' },
    { pergunta: 'Por que não se deve espremer a larva na miíase furunculoide?', resposta: 'Porque romper ou fragmentar a larva provoca reação inflamatória intensa, granuloma e infecção secundária. Ocluir o orifício e retirar íntegra é o caminho.', tema: 'miiase' },
    { pergunta: 'Qual prática comunitária na tungíase soma infecção secundária e risco de transmissão sanguínea?', resposta: 'A extração caseira com agulha, alfinete ou espinho compartilhados e não estéreis.', tema: 'tungiase' },
    { pergunta: 'Por que a larva migrans cutânea é autolimitada e nunca se torna sistêmica?', resposta: 'Porque o ser humano é hospedeiro acidental e a larva de ancilostomídeo de cão e gato não atravessa a membrana basal, ficando confinada à epiderme.', tema: 'larva_migrans_cutanea' },
    { pergunta: 'Quando a icterícia neonatal nunca é fisiológica, e como se decide a fototerapia?', resposta: 'Icterícia antes de 24 horas de vida nunca é fisiológica. A decisão se toma pela bilirrubina comparada ao limiar da hora de vida e do grupo de risco, não pela impressão visual.', tema: 'ictericia_neonatal' },
    { pergunta: 'Por que todo recém-nascido de mãe com sífilis é investigado, mesmo parecendo sadio?', resposta: 'Porque mais da metade dos casos de sífilis congênita é assintomática ao nascimento. E tratar a criança sem tratar a parceria da mãe garante reinfecção.', tema: 'sifilis_congenita' },
    { pergunta: 'O que não pode ser dado junto com o ciprofloxacino por via oral?', resposta: 'Leite, iogurte, antiácidos e sais de ferro ou cálcio, que quelam o fármaco e reduzem a absorção. Espaçar pelo menos 2 horas e orientar fotoproteção.', tema: 'ciprofloxacino' }
  ],
