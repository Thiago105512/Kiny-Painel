...
const ASSETS = ['./', './index.html', './css/styles.css', './manifest.webmanifest',
  './js/utils.js', './js/store.js', './js/entrada.js', './js/seguranca.js', './js/data/apoio-entrada.js', './js/data/locais.js', './js/data/violencia.js', './js/data/curiosidades.js', './js/data/comerciais.js', './js/data/alternativas.js', './js/calculators.js', './js/app.js',
