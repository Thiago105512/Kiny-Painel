...
const ASSETS = ['./', './index.html', './css/styles.css', './manifest.webmanifest', './img/mucurinha.png', './img/mucurinha-64.png', './img/mucurinha-grande.jpg',
  './js/utils.js', './js/store.js', './js/entrada.js', './js/seguranca.js', './js/plantoes.js', './js/nuvem.js', './js/agenda.js', './js/data/apoio-entrada.js', './js/data/locais.js', './js/data/violencia.js', './js/data/curiosidades.js', './js/data/didatica.js', './js/data/comerciais.js', './js/data/alternativas.js', './js/calculators.js', './js/app.js',
